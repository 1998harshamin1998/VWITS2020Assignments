        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
          <ul class="navbar-nav mr-auto">
            <li class="nav-item"> 
             ...
             <li class="nav-item">
             	 <!-- Button trigger modal -->
				<button type="button" class="nav-link btn btn-link" data-toggle="modal" data-target="#profileModal">
				  Profile
				</button>
            </li>
          </ul>
             
              <form action="logOut" method="get" class="form-inline mt-2 mt-md-0 ml-auto">
		  ...
		  <div class="modal-dialog" role="document">
		    <div class="modal-content">
		      ...
		      <div class="modal-footer">
		        ...
		        <a href="exam/1" class="btn btn-secondary">Start Exam</a>
		      </div>
		    </div>
		  </div>
		</div>
